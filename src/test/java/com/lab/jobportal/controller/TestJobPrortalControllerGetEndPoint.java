...
public class TestJobPrortalControllerGetEndPoint {
	...
	public void test_Get_all_end_point_with_xml_data() throws Exception {
		mvc.perform(get(contextPath + "/all").header("Accept", MediaType.APPLICATION_XML_VALUE))
	...
	public void test_Get_witid_end_point_with_json_data() throws Exception {
		mvc.perform(get(contextPath + "/find?id=1&jobTitle=Software Engg").header("Accept",
	...
	public void test_Get_witid_End_point_not_found() throws Exception {
		mvc.perform(get(contextPath + "/find?id=2&jobTitle=Software Engg").header("Accept",
	...
	public void test_Get_witid_end_point_missing_query_param() throws Exception {
		mvc.perform(get("/normal/webapi/find?jobTitle=Software Engg").header("Accept", MediaType.APPLICATION_XML_VALUE))
