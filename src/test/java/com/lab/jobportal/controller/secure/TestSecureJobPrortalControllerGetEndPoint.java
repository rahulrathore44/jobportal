...
public class TestSecureJobPrortalControllerGetEndPoint {
	...
	public void test_Get_all_end_point_with_xml_data() throws Exception {
		mvc.perform(get(contextPath + "/all").headers(getBasicAuthHeader()).header("Accept",
	...
	public void test_Get_witid_end_point_with_json_data() throws Exception {
		mvc.perform(get(contextPath + "/find?id=1&jobTitle=Software Engg").headers(getBasicAuthHeader())
	...
	public void test_Get_witid_End_point_not_found() throws Exception {
		mvc.perform(get(contextPath + "/find?id=2&jobTitle=Software Engg").headers(getBasicAuthHeader())
	...
	public void test_Get_witid_end_point_missing_query_param() throws Exception {
		mvc.perform(get(contextPath + "/find?jobTitle=Software Engg").headers(getBasicAuthHeader()).header("Accept",
	...
	public void test_Get_witid_end_point_missing_basic_auth_header() throws Exception {
		mvc.perform(get(contextPath + "/find?jobTitle=Software Engg").header("Accept", MediaType.APPLICATION_XML_VALUE))
